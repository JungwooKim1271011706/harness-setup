...
|----------|-----------|-------------|
| **critical** | 게이트 차단 | tautology, 7c 합의 케이스 누락, 구현 디테일/private 테스트, 가짜 RED 위장, mutation 관점 무력(동작 안 잡음), RED 픽스처 구조 결함(기준9: 테스트 간 논리모순·strict stub 겹침·primitive 매처 NPE) |
